...
\chead{%
  $12$$^{th}$ International Conference on Computational Social Science IC$^{2}$S$^{2}$\\
  July 28-31, 2026, Burlington, VT, United States%
}
...
\begin{center}
\textit{Keywords: congressional polarization, graph attention networks, spectral analysis, co-voting networks, computational social science}
\newline
\end{center}
