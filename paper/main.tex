...
A pattern in Table~\ref{tab:polarization} that warrants discussion: network density and mean degree do not show the same dramatic decline as the Fiedler value. In fact, density \textit{increases} from 0.453 in the 100th Congress to 0.493 in the 114th, even as the Fiedler value plummets from 0.534 to 0.010. The graph is not losing edges overall; it is reorganizing them. Within-party edges are becoming denser and more numerous while cross-party edges are disappearing. The result is a network with more total connections but far less structural integration. This distinction matters because it shows that polarization is not simply a story of legislators refusing to cooperate. It is a story of cooperation becoming exclusively partisan, a structural rewiring that aggregate measures like density completely miss.
...
What makes this finding more than a historical curiosity is what happened next. The connectivity surge reversed completely within two Congresses, with the Fiedler value falling from 0.843 back below 0.5 by the 109th. The system snapped back. Now compare this to the post-2010 period: after the Tea Party wave drove connectivity to near zero, no subsequent event, not the Trump presidency, not the January 6th crisis, not a global pandemic, produced anything resembling a recovery. The graph stayed disconnected. This asymmetry suggests something has changed not just about the level of polarization but about the system's capacity for structural resilience. In the early 2000s, a crisis could temporarily override partisan sorting and rebuild bipartisan cooperation. By the 2010s, that capacity appears to have been lost. The network has not just become more polarized; it has become brittle, unable to regenerate the cross-party connections that crises once produced.
...
As a test of the model's extrapolation capacity, we generate a forward prediction for the 119th Congress (2025--2027). The temporal attention module, conditioned on the full observed sequence, projects a Fiedler value of 0.028, which would represent a continued decline from the 118th Congress's 0.032 and a new low in our dataset. We offer this projection not as a definitive forecast but as a falsifiable prediction: if the 119th Congress produces a Fiedler value substantially above 0.03, it would suggest that some countervailing force has emerged that the model's historical patterns do not capture. If the value falls at or below 0.03, it would indicate that the structural dynamics driving disconnection remain firmly in place.
...
But the most important finding may be the simplest one. Polarization is not just about ideology. Two parties can be ideologically distant and still cooperate on enough issues to govern; the U.S. Congress managed this for most of the 20th century. What has changed is not just the distance between the parties but the structure of connections between them. The bridges that once allowed cross-partisan legislative coalitions to form have been systematically dismantled, and our spectral measures show this dismantling with precision. Equally troubling, the system appears to have lost its capacity for recovery: the post-9/11 rally demonstrated that exogenous shocks could temporarily rebuild bipartisan connectivity, but no event in the post-2010 era has produced anything comparable. The network has become not only disconnected but brittle.

If these trends continue, the implications extend beyond political science. A Congress that cannot form cross-partisan majorities cannot respond flexibly to crises, cannot compromise on fiscal policy, and cannot provide the stable governance that democratic legitimacy requires. The network structure we document is not an abstract mathematical curiosity; it is the scaffolding on which legislative capacity rests.

Return to where we began. By the time the government shut down on January 19, 2018, the co-voting network had already been structurally disconnected for half a decade. The Fiedler value had been near zero since the 113th Congress. The shutdown was not a breakdown. It was the network functioning exactly as its topology predicted.
